...
const overviewSalesmen = async (req, res) => {
    try {
        ...
        // Initialize an object to store data by date and grand totals
        const dailyOverview = {};
        const grandTotal = {
            totalSalesAmount: 0,
            totalCashSales: 0,
        ...
        for (let date of dates) {
            ...
            // Aggregate the grand totals
            grandTotal.totalSalesAmount += totalSalesAmount;
            grandTotal.totalCashSales += totalCashSales;
            grandTotal.totalCardSales += totalCardSales;
            grandTotal.totalReturnsAmount += totalReturnsAmount;
            grandTotal.totalCashReturns += totalCashReturns;
            grandTotal.totalCardReturns += totalCardReturns;
            grandTotal.netSales += netSales;
            grandTotal.netCashSales += netCashSales;
            grandTotal.netCardSales += netCardSales;
