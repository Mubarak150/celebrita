...
exports.placeOrder = async (req, res, next) => {
  ...
  try {
    ...
    // ************** may need to re-use this block of code *******************
    ...
    let deliveryCharges = city == "Peshawar" ? 0 : 350;
    ...
    // *********** this setting must be processed in ****************
    let notificationMessage = `a user ${response.user_name} has placed an order #${order.id}.`;
    await notifyAllAdmins(order.id, notificationMessage);
