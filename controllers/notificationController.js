  ...
  try {
    ...
    if (notifications.length === 0) {
      return res
        ...
        .json({
          success: false,
          message: "No viewed notifications found for this user",
        });
    }
    ...
    res
      ...
      .json({
        success: true,
        message: "All viewed notifications deleted successfully",
      });
  } catch (error) {
    res
      .status(500)
      .json({ success: false, message: "Error deleting notifications" });
  }
};
