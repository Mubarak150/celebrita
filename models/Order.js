...
const Order = sequelize.define('Order', {
  ...
  status: {
    type: DataTypes.ENUM('pending', 'approved', 'on-the-way', 'received', 'return-pending', 'return-approved', 'return-on-the-way', 'return-received', 'completed', 'rejected'),  // specific values
